      ...
      <nav>
        <div class="table-aligned-div">
          <ul>
            ...
            <li><button type="button" class = "nav-tab form-button" onClick="adminButton()">Admin</button></li>
            </ul>
        </div>
      </nav>
      <script src="nav.js"></script>
    </header>
    <div class="clip table-aligned-div">
      <p class="days-events scroll-rtl table-aligned-div"><!-- This will be dynamically filled in --></p>
    </div>
    <table class="table-aligned-div calendartable">
      <tbody>
        <?php
